...
final List<FoodItem> featuredPartners = [
  FoodItem(
      ...
      price: 20,
      description:
          "Coffee is a brewed drink prepared from roasted coffee beans, the seeds of berries from certain flowering plants in the Coffee genus.",
      shippingPrice: 0),
  FoodItem(
      ...
      review: 4.3,
      description:
          "The Mushroom Kingdom is a fictional principality in Nintendo's Mario series.",
      price: 25,
      shippingPrice: 25),
  FoodItem(
