                        ...
                        onPressed: () {
                          ...
                          if (!orders.restaurantOrderedFoodItems
                            ...
                            if (!orders
                              ...
                              orders.restaurantOrderedFoodItems[
                                      widget.restaurant]![widget.foodItem] =
                                  numberOfOrders;
                            } else {
                              ...
                              if (isPaidFound) {
                                FoodItem foodItem = FoodItem(
                                    ...
                                    preparationTime:
                                        widget.foodItem.preparationTime,
                                    shippingAddress:
                                        widget.foodItem.shippingAddress,
                                    shippingPrice:
                                        widget.foodItem.shippingPrice,
                                    review: widget.foodItem.review,
                                    name: widget.foodItem.name,
                                    imagePath: widget.foodItem.imagePath);
                                orders.restaurantOrderedFoodItems[widget
                                    .restaurant]![foodItem] = numberOfOrders;
                              } else {
                                orders.restaurantOrderedFoodItems[
                                        widget.restaurant]!
                                    .update(
